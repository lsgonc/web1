...
public class ClinicaMedicaApplication {
    ...
    public CommandLineRunner demo(IMedicoDAO medicoDAO, IPacienteDAO pacienteDAO, IConsultaDAO consultaDAO, BCryptPasswordEncoder encoder) {
        return (args) -> {
            ...
            Paciente p1 = new Paciente("111.222.333-44", "paciente1@gmail.com", encoder.encode("paciente"), Usuario.TipoUsuario.PACIENTE, "Ana", "(33) 77777-7777", "F", "1990-03-03");
            Paciente p2 = new Paciente("555.666.777-88", "paciente2@gmail.com", encoder.encode("paciente"), Usuario.TipoUsuario.PACIENTE, "Carlos", "(44) 66666-6666", "M", "1985-04-04");
            pacienteDAO.save(p1);
            pacienteDAO.save(p2);
